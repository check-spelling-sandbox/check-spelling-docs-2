...
- [Only changed doesn't work when PRs are initially created from forks](#onlychangeddoesntworkwhenprsareinitiallycreatedfromforks)
- [Too many unrecognized words](#toomanyunrecognizedwords)
- [@dependabot can't comment](#dependabotcantcomment)
