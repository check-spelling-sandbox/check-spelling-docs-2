...
- [How do I upgrade?](#howdoiupgrade)

- [How do I get comments to collapse?](#howdoigetcommentstocollapse)

- [Why can't I see the 👼 SARIF report?](#whycantiseethesarifreport)
...
New releases of check-spelling will add new features, some of which may be enabled by default. But, often, to avoid behavior changes to existing deployments, they require opting in, and thus additional flags via [workflow parameters](Configuration.md#workflowparameters).
...
There are lots of reasons comments won't collapse, but the fix is generally to [refresh your workflow](#howdoiupgrade).
